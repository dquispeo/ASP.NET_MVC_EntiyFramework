...
namespace University.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View(db.Student.Where(s => s.Estado == true).ToList());
        }
        ...
        [ValidateAntiForgeryToken]
       /* public ActionResult DeleteConfirmed([Bind(Include = "StudentID,LastName,FirstName,Email,EnrollmentDate")] Student student)
        {*/
