...
namespace University.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.StudentID = new SelectList(db.Student.Where(s => s.Estado == true), "StudentID", "LastName");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "EnrollmentID,Grade,CourseID,StudentID")] Enrollment enrollment)
        {
            ...
            ViewBag.StudentID = new SelectList(db.Student.Where(s => s.Estado == true), "StudentID", "LastName", enrollment.StudentID);
            return View(enrollment);
        }
